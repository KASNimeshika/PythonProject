...
import mysql.connector # connect database
...
class DetailsRoom:
    def __init__(self, root):
        ...
        btnReset = Button(btn_frame, text="Reset",command=self.reset_data ,font=("arial", 11, "bold"), bg="#7F5628", fg="#FFFFFF", width=10)
   ...
   #add_data
    def add_data(self):
        if self.var_floor.get() == "" or self.var_RoomType.get() == "":
            messagebox.showerror("Error", "all field are requred",parent=self.root)
        else:
            try:
